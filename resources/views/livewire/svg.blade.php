            ...
            <svg id="Layer_2" class='' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 153.87 240.5">
                ...
                <g id="Back_ID">
                    <line id="Red_Dash_Linw" class="cls-9" x1="61.68" y1="188.25" x2="145.09" y2="187.45" /><text class="cls-3" transform="translate(60.24 230.96)">
                        ...
                        <tspan class="cls-8" x="0" y="0">{{$staff->name}}</tspan>

                        <tspan x="0" y="18">{{$staff->name}}</tspan>

                    </text>

                    <image style="overflow:visible;" width="377" height="379" id="WORKER-IMG" xlink:href="{{$staff->staff_prints}}" transform="matrix(0.2535 0 0 0.2535 56.6439 30.8369)"></image>
